...
Result<JsonObject> ProjectJsonHandler::parseJson(const std::string &json) {
  ...
  for (auto it = begin; it != end; ++it) {
    ...
    std::string fullValue = match[3].str();

    if (fullValue.empty()) {
      // Not a string, check other types
      fullValue = match[0].str();
...
Result<void> ProjectJsonHandler::parseFromString(const std::string &json,
  ...
  outMetadata.version =
      getOptionalField<std::string>(obj, "version", "1.0.0").value();
  outMetadata.author =
      getOptionalField<std::string>(obj, "author", "").value();
  outMetadata.description =
      getOptionalField<std::string>(obj, "description", "").value();
  outMetadata.engineVersion =
      getOptionalField<std::string>(obj, "engineVersion", "0.2.0").value();
  outMetadata.startScene =
      getOptionalField<std::string>(obj, "startScene", "").value();
  outMetadata.defaultLocale =
      getOptionalField<std::string>(obj, "defaultLocale", "en").value();
  outMetadata.targetResolution =
      getOptionalField<std::string>(obj, "targetResolution", "1920x1080")
          .value();
  outMetadata.fullscreenDefault =
      getOptionalField<bool>(obj, "fullscreenDefault", false).value();
  outMetadata.buildPreset =
      getOptionalField<std::string>(obj, "buildPreset", "release").value();

  // Timestamps
  outMetadata.createdAt =
      static_cast<u64>(getOptionalField<i64>(obj, "createdAt", 0).value());
  outMetadata.modifiedAt =
      static_cast<u64>(getOptionalField<i64>(obj, "modifiedAt", 0).value());
  outMetadata.lastOpenedAt =
      static_cast<u64>(getOptionalField<i64>(obj, "lastOpenedAt", 0).value());
